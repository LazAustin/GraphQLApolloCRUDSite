...
export default function AddProjectModal() {
  ...
  return (
    <>
        { !loading && !error && (
            <>
                <button type="button" className="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#addProjectModal">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form onSubmit={onSubmit}>
                                    ...
                                    <button type='submit data-bs-dismiss' className='btn btn-primary'>
                                        Submit
                                    </button>
                                </form>
                            </div>
